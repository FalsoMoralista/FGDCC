...
def main(args, resume_preempt=False):
    ...
    prototype_features = args['k_means']['prototype_features']
    ...
    fgdcc = ClassificationModel(vit_backbone=target_encoder,
                                ...
                                nb_classes=nb_classes).to(device)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for itr, (((image1, target), (image2, _)), masks_enc, masks_pred) in enumerate(supervised_loader_train):
            ...
            def load_imgs():
                ...
                return (imgs_1, targets)
            
            imgs_1, targets = load_imgs()
            ...
            def train_step():
                ...
                with torch.cuda.amp.autocast(dtype=torch.bfloat16, enabled=use_bfloat16):
                    ...
                    subclass_loss = criterion(subclass_logits, targets)
